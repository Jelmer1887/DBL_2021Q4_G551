...
const routes: Routes = [
  ...
  children:[
    {path: 'force', component: FooterComponent, outlet: 'vis1'},
    {path: 'arc', component: NavBarComponent, outlet: 'vis1'},
    {path: 'force', component: FooterComponent, outlet: 'vis2'},
    {path: 'arc', component: NavBarComponent, outlet: 'vis2'}
  ]},
